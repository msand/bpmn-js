...
BpmnImporter.prototype.add = function(semantic, parentElement) {
  ...
  // SHAPE
    ...
    var host,
        hostBusinessObject,
        isBoundaryEvent = is(semantic, 'bpmn:BoundaryEvent');
    ...
    if (isBoundaryEvent) {
      hostBusinessObject = semantic.attachedToRef;

      host = this._elementRegistry.get(hostBusinessObject.id);

      attrs.host = host;
    }

    element = this._elementFactory.createShape(elementData(semantic, attrs));
